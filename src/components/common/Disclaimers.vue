<template>
  <a-drawer width="80vw" title="免责声明" placement="right" :open="open" @close="close" rootClassName="disclaimers-root">
    <div class="disclaimers-drawer">
      ...
      <p>4. 为保护您的个人隐私，您的个人数据，全部保存在您的个人设备中，更换浏览器和清理浏览器缓存，都会导致历史提问数据一并被清理，如有重要信息，请及时做好备份。本站提供的信息资料、图片及视频等均来源于公开网络，本站仅提供各大平台热搜聚合服务，所有详细信息均跳转到原始网页地址访问，不做任何转码类操作，服务器不存储任何信息，如果侵犯您的权益，请与我们联系,我们会及时处理。同时请注意原网站的观点不表示我们也认同，信息内容真实性请自己辨别。</p>
