<template>
  ...
  <a-modal :title="title" v-model:open="cropperVisible" :width="860" :footer="null" class="image-editor-dialog" :maskClosable="false" @cancel="handleCancel" destroyOnClose>
    <a-row :gutter="20">
      <a-col :span="16">
